...
def build_search_payload_with_url(url: str, limit: int = 35, limit_alu: int = 3, page: int = 1):
                        ...
                        match prefix_parts[0]:
                            case "d":  # Department
                                payload["filters"]["location"]["locations"].append(
                                    {"locationType": "department", "department_id": location_id}
                                )
                            case "r":  # Region
                                payload["filters"]["location"]["locations"].append(
...
def build_search_payload_with_args(
    ...
    locations: list[Region | Department | City] | Region | Department | City | None = None,
    limit: int = 35,
    limit_alu: int = 3,
    page: int = 1,
